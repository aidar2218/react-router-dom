...
import {ShoesItemType} from "./Adidas";
import {Link} from "react-router-dom";
import {S} from "./_styles";


export const pumaArr: ShoesItemType[] = [
    {
        id: 1,
    ...
    {
        id: 2,
        model: 'Puma Trinity Mid Hybrid Leather',
            ...
            <S.Images>
                {pumaArr.map((el, index) => (
                    <Link key={index} to={`/puma/${el.id}`}>
                        <S.ImgShoes src={el.picture} alt={el.model}/>
                    </Link>
                ))}
            </S.Images>
            <p>
